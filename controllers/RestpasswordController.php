...
require_once '../models/RestpasswordModel.php';
...
class RestpasswordController{
    ...
    public function __construct(){
        $this->resetModel = new RestpasswordModel;
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = 'cb2a212e0084fc';
        $this->mail->Password = 'a98d513bfa1b41';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://localhost/loginmvc/View/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
...
$init = new RestpasswordController;
